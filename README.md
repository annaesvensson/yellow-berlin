...
[Download ZIP file](https://github.com/annaesvensson/yellow-berlin/archive/main.zip) and copy it into your `system/extensions` folder. [Learn more about extensions](https://github.com/annaesvensson/yellow-update).
